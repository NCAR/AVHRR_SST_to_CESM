...
# ds277.0 changed directory and file names in the months before 2020-6.
# set product = avhrr
...
#       tar -xvf ${tar_file} 
   if (! -d $yr) then
      mkdir $yr
      cd $yr
# ds277.0 changed directory and file names, and compression in the months before 2020-6.
